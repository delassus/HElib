...
int main()
{
  ...
  auto NotOfOr2CC =
      encrypted_database.contains(queryNotOfOr2, encrypted_query).apply(clean);
  ...
  auto NotOfOr2CP = encrypted_database.contains(queryNotOfOr2,plaintext_query).apply(clean);
  // decrypt results
  ...
  auto NotOfOr2PC = plaintext_database.contains(queryNotOfOr2, encrypted_query).apply(clean);
  // decrypt results
  ...
  auto NotOfOr2PP = plaintext_database.contains(queryNotOfOr2, plaintext_query).apply(clean);
